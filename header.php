                ...
                <div class="drawer-content">
                    ...
                    wp_nav_menu(
                        array(
                            ...
                            'container_class' => 'drawer-nav', //ulを囲っている要素のクラス名を記述
                            'menu_class' => 'drawer-list', //ulのクラス名を記述
                        )
                    );
                    ?>
                </div><!-- /drawer-content -->
        ...
        <div class="inner">
            ...
            wp_nav_menu(
                ...
                array(
                    ...
                    'container' => 'false', //ulを囲っている要素、なければ'false'を記述（falseの場合、container_classの項目は削除でOK）
                    'menu_class' => 'header-list', //ulのクラス名を記述
                )
            );
            ?> </div><!-- /inner -->
    </nav><!-- header-nav -->